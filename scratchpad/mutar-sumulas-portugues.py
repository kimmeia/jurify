...
MUTACOES = [
    ...
    ("o detalhe técnico é REMOVIDO da tela (não é isso que foi pedido)", PAINEL,
     '<TableHead className="text-right">Detalhe técnico</TableHead>', "", AMARRA),
    ...
    ("a coluna 'dá pra ler daqui?' sai da tabela de fontes", ABA,
     "<TableHead>Dá pra ler daqui?</TableHead>", "", AMARRA),
