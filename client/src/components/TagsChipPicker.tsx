        ...
        <div className="flex flex-wrap gap-1.5">
          ...
          {podeCriar && (
            <button
              ...
              className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[11px] font-medium border border-dashed border-info/30 text-info-fg hover:bg-info-bg transition-colors"
            >
              {criarTag.isPending ? (
