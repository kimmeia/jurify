...
export default function NotFound() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-slate-50 dark:from-slate-900 to-slate-100 dark:to-slate-900/40">
