 ...
 *
 * Token vem na query string. Backend valida (existe, não usado, não expirou)
 * e troca a senha. Mostra erro amigável se inválido/expirado.
 */
