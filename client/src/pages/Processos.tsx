                          ...
                          <div className="text-xs">
                            ...
                            {prazo && (
                              <div className="mt-1.5 rounded-md bg-orange-50 border border-orange-200 px-2 py-1.5 flex items-center justify-between gap-2 flex-wrap dark:bg-orange-950/20 dark:border-orange-900">
                                <span className="text-[10px] text-orange-800 dark:text-orange-300">⏰ <b>{prazo.titulo}</b> — {prazo.prazoDias} dias{prazo.prazoUteis ? " úteis" : ""}{prazo.dataSugerida ? ` · vence ${formatarDataCalendario(prazo.dataSugerida)}` : ""}</span>
