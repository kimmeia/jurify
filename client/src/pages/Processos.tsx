                      ...
                      <div className="mt-3 rounded-lg bg-muted/70 border border-border/70 p-3 space-y-1.5">
                        ...
                        {natureza && (
                          <div className="pt-2 mt-1 border-t border-border/70">
                            ...
                            {capa?.fonte && (
                              <span className={`mt-1 inline-flex items-center gap-1 px-1.5 py-0.5 rounded-full border text-micro font-semibold ${capa.fonte === "datajud" ? "bg-info-bg text-info-fg border-info/30" : "bg-success-bg text-success-fg border-success/30"}`}>
                              ...
                              <div className="min-w-0">
                                ...
                                {!capa && (
                                  <Button
                                    size="sm"
                                    variant="outline"
                                    className="mt-2 h-7 text-apoio rounded-lg bg-card border-warning/40 hover:bg-warning-bg text-warning-fg"
                                  ...
                                  >
                                    ...
                                    <span className="ml-1 text-micro opacity-70">grátis</span>
                                  </Button>
                                )}
                              </div>
                            </div>
                            ...
                            >
                              ...
                              {a.capaFalhou && !capa
                                ...
                                : capa?.daDeteccao
                                  ? "Ver movimentações"
                                  : "Carregar detalhes"}
                              <span className="ml-1 text-micro opacity-70">1 consulta</span>
                            </Button>
                          </div>
                        )}
                      </div>
