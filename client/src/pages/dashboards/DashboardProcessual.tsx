...
import GuiaProcessual from "./GuiaProcessual";
...
export default function DashboardProcessual() {
  ...
  // vazia parecia "tudo certo". O guia de 3 passos cobre esse buraco: ele
  // fica na tela enquanto faltar credencial ou monitoramento.
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto space-y-4">
      ...
      <GuiaProcessual credenciais={credenciais} monitoramentosAtivos={data.monitoramentosAtivos} />
