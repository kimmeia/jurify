 ...
 * protocolar.
 *
 * Vive num componente, e não numa página, porque é usado em dois lugares: a
 * rota /agente-juridico e o modo "Redigir peça" do JurisIA. `embutido` tira a
 * casca de página (voltar, título) pra ele caber dentro de outra tela.
 */
...
export function RedatorPeca({ embutido = false }: { embutido?: boolean }) {
  ...
  return (
    <div
      className={
        embutido
          ? "flex flex-col h-[calc(100dvh-230px)] min-h-[500px] overflow-hidden rounded-xl border bg-card"
          : "flex flex-col h-[calc(100dvh-56px)]"
      }
    >
      {/* Top bar */}
