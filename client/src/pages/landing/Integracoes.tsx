  ...
  return (
    <section className="border-y bg-white py-8">
      <div className="mx-auto max-w-6xl px-4">
        <p className="text-center text-xs font-semibold uppercase tracking-[0.06em] text-slate-400">
        ...
        <div className="mt-4 flex flex-wrap items-center justify-center gap-3">
          {integracoes.map((i) => (
            <span
              key={i.nome}
              className="inline-flex items-center gap-2 rounded-full border bg-white px-4 py-2 text-[15px] font-bold text-slate-700"
            >
