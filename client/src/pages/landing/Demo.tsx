    ...
    <section id="demo" className="border-y border-white/[0.06] bg-[#0a0817]">
      <div className="mx-auto max-w-6xl px-4 py-24">
        <Reveal as="div" className="grid items-center gap-14 lg:grid-cols-2">
          {/* Copy */}
          <div>
            <p className="text-sm font-bold uppercase tracking-[0.08em] text-info">Contratos</p>
            ...
            <p className="mt-4 text-lg leading-relaxed text-info/70">
              Sobe um{" "}
              <code className="rounded bg-info/20 px-1.5 py-0.5 font-mono text-sm text-info-fg">.docx</code>{" "}
              com placeholders{" "}
              <code className="rounded bg-info/20 px-1.5 py-0.5 font-mono text-sm text-info-fg">{"{{1}}"}</code>,{" "}
              <code className="rounded bg-info/20 px-1.5 py-0.5 font-mono text-sm text-info-fg">{"{{2}}"}</code>…
              e cada um vira um campo.
            </p>
            <ul className="mt-6 space-y-3.5 text-info/80">
          ...
          <div className="rounded-2xl border border-white/[0.13] bg-white/[0.12] to-white/[0.04] p-2 shadow-[0_40px_80px_-28px_rgba(0,0,0,0.7)]">
            <div className="overflow-hidden rounded-xl border border-black/5 bg-white">
              <div className="flex h-9 items-center gap-2 border-b bg-muted px-4">
                ...
                <span className="flex-1 text-center font-mono text-[11px] text-muted-foreground/70">
              ...
              <div className="space-y-3 bg-[#fafaff] p-5">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-bold text-foreground">Contrato de Honorários — Trabalhista</span>
                ...
                <div className="space-y-2 rounded-lg border bg-white p-3">
                  <div className="flex items-center gap-2">
                    <Badge className="border-0 bg-info-bg font-mono text-xs text-info-fg">{"{{1}}"}</Badge>
                  ...
                  <div className="flex items-center gap-2 text-xs text-foreground">
                    ...
                    <code className="rounded bg-muted px-1.5 py-0.5 font-mono">cliente.nome</code>
                ...
                <div className="space-y-2 rounded-lg border bg-white p-3">
                  <div className="flex items-center gap-2">
                    <Badge className="border-0 bg-info-bg font-mono text-xs text-info-fg">{"{{2}}"}</Badge>
                    <Badge className="border-0 bg-warning-bg text-[10px] text-warning-fg">Manual</Badge>
                  </div>
                  ...
                  <input
                    ...
                    readOnly
                    className="w-full rounded border bg-white px-2 py-1.5 text-xs text-foreground"
                  />
                </div>

                <div className="rounded-md bg-info py-2 text-center text-sm font-medium text-info-on">
                  Gerar e baixar (.docx)
                </div>
              </div>
            </div>
