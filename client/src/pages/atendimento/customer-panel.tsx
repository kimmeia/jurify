      ...
      {contato.origemAnuncio && (
        <div className="px-4 pt-1">
          <div className="border-t pt-3">
            <div className="text-[10.5px] font-bold tracking-wider uppercase text-accent-purple-fg mb-2">
              Origem
            </div>
            <div className="flex gap-2.5 items-start">
              <div className="fundo-hero w-14 h-9 rounded-md shrink-0 flex items-center justify-center overflow-hidden">
                {contato.origemAnuncio.thumbnailUrl || contato.origemAnuncio.imagemUrl ? (
                  ...
                  <Megaphone className="h-3.5 w-3.5 text-hero-fg" />
                )}
              </div>
              <div className="min-w-0 flex-1">
                ...
                {contato.origemAnuncio.sourceUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="text-[11px] font-semibold text-accent-purple-fg hover:underline inline-flex items-center gap-1 mt-1"
                  >
