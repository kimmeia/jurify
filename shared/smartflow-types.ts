...
export const TIPO_PASSO_META: ReadonlyArray<TipoPassoMeta> = [
  ...
  { id: "agenda_criar", label: "Agendar na Agenda (interno)", descricao: "Cria um compromisso na Agenda do escritório, atribuído a um responsável e vinculado ao cliente — sem depender do Cal.com. Nasce como 'pendente' pra equipe confirmar.", cor: "bg-orange-100 text-orange-700 dark:bg-orange-900/40 dark:text-orange-300", grupo: "acoes" },
