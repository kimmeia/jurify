...
export const TIPO_PASSO_META: ReadonlyArray<TipoPassoMeta> = [
  ...
  { id: "agenda_criar", label: "Agendamento (JuriFlow)", descricao: "Mexe na Agenda do escritório (não no Cal.com). Ações: agendar, verificar horário disponível, editar/remarcar e cancelar. Atribui a um responsável e vincula ao cliente.", cor: "bg-orange-100 text-orange-700 dark:bg-orange-900/40 dark:text-orange-300", grupo: "acoes" },
