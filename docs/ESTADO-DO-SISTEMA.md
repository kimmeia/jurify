...
1. O sistema é grande e está saudável na base: **5.950 testes verdes** (13/09, com a cor do menu na branch; 5.944 em develop e main; eram 5.570 no início da auditoria), tipos
...
|---|---|---|
| testes | **5.950 verdes, 399 arquivos** (13/09, com a cor do menu na branch; 5.944 em 398 em develop e main; 5.570 em 380 no início da auditoria) | `pnpm test` |
