...
## 32. Jurisprudência de verdade: o robô que busca ementa, e os dois módulos viram um (14/09)
...
### 32.1 O diagnóstico que decidiu o desenho
...
### 32.3 As cinco decisões que carregam o resto
...
### 32.4 Conferido com o sistema rodando (não deduzido)
...
### 32.5 O que NÃO foi feito, e por quê
...
## 36. Origem por anúncio no Inbox: selo, filtro e cartão da conversa (14/09)
