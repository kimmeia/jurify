...
Se você não solicitou, ignore este email.`;
  ...
  return enviarEmail({
    to: params.email,
    subject: "Redefinir sua senha — Jurify",
    html,
    text,
  });
}
...
/**
 * Email de boas-vindas após signup. Inclui CTA pra completar o
 * onboarding (criar primeiro escritório / explorar o app).
 */
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background: #f9fafb;">
  <div style="background: white; border-radius: 12px; padding: 32px; border: 1px solid #e5e7eb;">
    ...
    <p style="color: #4b5563; font-size: 15px; line-height: 1.6;">
      Sua conta foi criada com sucesso. Estamos felizes em ter você.
    </p>

    <p style="color: #4b5563; font-size: 15px; line-height: 1.6;">
      Pra começar, você pode:
    </p>
